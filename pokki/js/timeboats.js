...
(function() {
  ...
  exports.Timeboats = Timeboats = (function() {
    ...
    function Timeboats(game, context, width, height, api, document, options, max_time) {
      ...
      this.max_time = max_time != null ? max_time : 10;
    ...
    Timeboats.prototype.drawHUD = function(context) {
      var time;
      time = this.max_time - this.frame_history[this.frame_num].time;
...
(function() {
  ...
  exports.State = State = (function() {
    ...
    State.prototype.update = function(dt, options) {
      ...
      for (id in _ref3) {
        object = _ref3[id];
        if (object.__type === 'Mine' || (object.__type === 'Checkpoint' && !object.checked)) {
          gold++;
          break;
        }
      }
      if (gold === 0) this.gameover = true;
      return true;
    };
...
(function() {
  ...
  exports.Map = Map = (function() {
    ...
    Map.prototype.generate = function(width, height, seed, players, options) {
      ...
      numCheckpoints = options.numCheckpoints != null ? options.numCheckpoints : 3;
      ...
      numMines = options.numMines != null ? options.numMines : 10;
      for (i = 0; 0 <= numMines ? i < numMines : i > numMines; 0 <= numMines ? i++ : i--) {
...
(function() {
  var AssetLoader, GameObject2D, Goldsplosion, Mine, Minesplosion, Point, Random;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.Mine = Mine = (function() {
    ...
    Mine.prototype.update = function(dt, state) {
      ...
      this.vx *= 0.999;
      if (this.x < -this.radius - 5 || this.y < -this.radius || this.x > 720 + this.radius + 5 || this.y > 560 + this.radius) {
        state.removeObject(this.id);
      }
    ...
    Mine.prototype.collide = function(state) {
      var explosion;
      explosion = new Minesplosion("minesplosion" + this.id, this.x + 15, this.y + 5, 40);
      state.addObject("minesplosion" + this.id, explosion);
...
require.define("/minesplosion.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var AssetLoader, GameObject2D, Minesplosion, Point, Random;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  exports.Minesplosion = Minesplosion = (function() {

    __extends(Minesplosion, GameObject2D);

    Minesplosion.prototype.__type = 'Minesplosion';

    function Minesplosion(id, x, y, max_radius) {
      this.id = id;
      this.x = x;
      this.y = y;
      this.max_radius = max_radius;
      Minesplosion.__super__.constructor.call(this, this.id, this.x, this.y);
      this.lifespan = this.ttl = 0.4;
      this.seed = this.x + this.y;
      this.radius = this.max_radius;
    }

    Minesplosion.prototype.clone = function() {
      var exp;
      exp = new Minesplosion(this.id, this.x, this.y, this.max_radius);
      exp.lifespan = this.lifespan;
      exp.ttl = this.ttl;
      return exp;
    };

    Minesplosion.prototype.update = function(dt, state) {
      this.ttl -= dt;
      Minesplosion.__super__.update.call(this, dt, state);
      if (this.ttl <= 0) return state.removeObject(this.id);
    };

    Minesplosion.prototype.draw = function(context) {
...
(function() {
  var AssetLoader, Map, MenuBoats, Player;
  ...
  exports.MenuBoats = MenuBoats = (function() {
    ...
    function MenuBoats(canvas, context, width, height, document) {
      ...
      console.log(seed);
      Map.getInstance().generate(this.width / Map.CELL_SIZE_PX, this.height / Map.CELL_SIZE_PX, seed, []);
      this.full_redraw = false;
      if (this.document != null) {
...
(function() {
  ...
  GameRenderer = (function() {
    ...
    GameRenderer.render = function(game) {
      var active_turn, idx, player, player_idx, turn, turn_idx, _ref, _ref2;
      $('#turn_tiles').html('');
      $('#player_tiles').html('');
      ...
      if (game.turns.length > 0) {
        ...
        for (turn_idx = 1, _ref2 = game.turns.length; 1 <= _ref2 ? turn_idx <= _ref2 : turn_idx >= _ref2; 1 <= _ref2 ? turn_idx++ : turn_idx--) {
          idx = game.turns.length - turn_idx;
          turn = game.getTurnByIndex(idx);
          this.renderTurnTile(turn, idx, game, false, false);
        }
  ...
  exports.Game = Game = (function() {
    ...
    Game.prototype.name = function() {
      var player_id, ret, _i, _len, _ref;
      ret = [];
      _ref = this.order;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player_id = _ref[_i];
        ret.push(this.players[player_id].nickname);
      }
      return ret.join(', ');
    };
    ...
    Game.prototype.latestTurnTime = function() {
      return this.getTurnByIndex(this.latestTurnNumber()).time;
    };
...
require.define("/client.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  drawPlayer = function(player, goodScore) {
    var html, negativeRanks, positiveRanks, rank;
  ...
  getRandomNicknames = function(numNicknames) {
    var i, j, nicks, x;
  ...
  load = function() {
    ...
    $('#tutorial').click(function() {
      $("#buttons button").prop("disabled", true);
      return $("#buttons").fadeOut(1000, function() {
        tutorial = 1;
      ...
      if (tutorial === 1) {
        ...
        $("#game-canvas").fadeOut(1000, function() {
          timeboats = loadTutorial({
            numMines: 0,
            numCheckpoints: 2
          }, 1329373618445, game_context, game_canvas.width, game_canvas.height, [
            {
